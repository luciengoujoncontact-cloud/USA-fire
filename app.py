...
# --- PAGE ANALYSE SEVERITE (ISMAIL) OPTIMISÉE ---
    ...
    # 1️⃣ Distribution de la taille des feux (log)
    ...
    # 3️⃣ Surface totale brûlée par classe
    ...
    # 4️⃣ Tendance de la sévérité par année
    ...
    # 5️⃣ Distribution des causes par taille de feu
